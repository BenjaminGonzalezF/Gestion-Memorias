                            ...
                            <v-container>
                                ...
                                <v-card-text color="#F4F4F4">
                                    ...
                                    <v-row justify="space-around"> 
                                        <v-btn class="white--text mt-3" color="rgb(0, 204, 255)" @click="agregar_temas(true,nombre_temacrear,descripcion_temacrear)" :disabled="((nombre_temacrear==null)||(descripcion_temacrear==null))" >
                                            Crear</v-btn>
                                        </v-row>
                                </v-card-text>
                            </v-container>
